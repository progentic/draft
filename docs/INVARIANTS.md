...
- Add frontend view integration and close-command coverage when those surfaces
  exist.
- Add bibliography/job, product-worker cancellation, and import invariant tests
