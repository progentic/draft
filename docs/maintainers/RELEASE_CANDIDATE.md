...
| GATE-47 | Roadmap gate | Open | The envelope-v2 paragraph model, migration, editor preservation, and DOCX property mapping exist, but external-format lifecycle, parsing, same-format save, fidelity/lossiness decisions, and complete evidence do not. | Document interoperability | Phase 47 | `RC-07` closes with the accepted format matrix, lifecycle, fidelity, lossiness, source-preservation, and fixture evidence. |
