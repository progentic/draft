...
| RC-07 | Release blocker | Open | Phase 47 mechanically implements bounded DOCX paragraph import, closed fidelity/lossiness categories, Rust-owned source provenance, no-edit source preservation, and typed path-free failures. Parsed Markdown, same-format DOCX save, governed ODT/RTF dispositions, compatible-reader comparison, packaged validation, and complete format evidence remain absent. | Document interoperability | Phase 47 | Supported-format fixtures, Rust-owned lifecycle state, explicit fidelity classes, no-edit source preservation, typed failures, and lossless or rejected-lossy save behavior pass. |
...
| GATE-47 | Roadmap gate | Open | The envelope-v2 paragraph model, migration, editor preservation, DOCX property mapping, bounded DOCX reader, external-source lifecycle, and fidelity/lossiness decisions exist mechanically. Same-format save, parsed Markdown, ODT/RTF disposition, compatible-reader comparison, packaged validation, and complete evidence do not. | Document interoperability | Phase 47 | `RC-07` closes with the accepted format matrix, lifecycle, fidelity, lossiness, source-preservation, and fixture evidence. |
